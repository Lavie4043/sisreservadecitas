...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $total_mensajescontacto = MensajeContacto::count();
        ...
        return view('admin.index', compact('total_usuarios', 'total_secretarias', 'total_pacientes', 'total_consultorios', 'total_doctores', 'total_horarios', 'consultorios', 'doctores', 'eventos', 'total_eventos', 'total_configuraciones',  'pacientes', 'total_mensajescontacto'));
    }
