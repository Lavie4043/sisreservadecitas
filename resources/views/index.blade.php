  ...
  <main class="main">
    ...
    <section id="hero" class="hero section light-background">
      ...
      <div class="container position-relative">
        ...
        <div class="content row gy-8">
          <div class="d-flex justify-content-center align-items-center" "col-lg-8 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="400">
